...
var6 = {type=CONTROLLER_TYPE.SWITCH, title=" (Only donates Archers!)", key="", value="1"}

dialogCtrls = {var1, var2, var3, var4, var5, var6}
...
repeat
	...
	results = findImage("CoCBotImages/Donate.bmp", 8, 0.5, nil, {191, 0, 384, 735})
		...
		usleep(1000000)
			...
			for i=1, 8 do
				...
				results = findImage("CoCBotImages/Archers.bmp", 8, 0.5, nil, {9, 839, 1521, 1148})
	...
	if getColor(1294, 700) == ThrowArrow or getColor(1294, 700) == TimeColor then
...
until getColor(1294, 700) == PlainColor
